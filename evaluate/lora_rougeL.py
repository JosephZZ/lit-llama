...
def main(
    ...
    lora_path: Path = Path("out/lora/lit-llama-2-rolebench/eng_instruction_generalization_gaston_100/7B/lora_r8_alpha16_dropout0.05_lr0.0001_bs32_epoch200_warmup5/epoch-100.8-valloss3.2011.pth"),
    ...
    for sample in data_test:
        ...
        if i % 200 == 0:
            ...
            if is_save_results_to_file:
                ...
                file_path = lora_path.parent / (test_file_path.stem + "_" + test_role + "_" + lora_path.stem + "_results.json")
