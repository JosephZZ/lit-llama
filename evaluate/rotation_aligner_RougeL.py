...
def main(
    ...
    aligner_path: Path = Path("out/rotation_aligner_globalRotation-True/lit-llama-2-eng_instruction_generalization_sheldon_100/7B/1vector-start_layer2-lr0.005bs32weightDecay0.02wu30/epoch-595.2-valloss1.6168"),
