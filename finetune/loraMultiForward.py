...
from lit_llama.loraMultiForward import mark_only_lora_as_trainable, lora, lora_state_dict
...
out_dir: str = f"out/loraMultiForward_{num_of_forwards}/{model_base}-{data_name}/{model_version}/lora_r{lora_r}_alpha{lora_alpha}_dropout{lora_dropout}_lr{learning_rate}_bs{batch_size}_epoch{epoch_num}warmup{warmup_iters}"
