...
embd_proj_weights = "out/alignerMlpParamedOneHeadSharedGating/lit-llama-2-lima/7B/1vector-start_layer2-lr9e-05bs32/epoch-10.0-iter-009999.pth"

previous_aligner_path = "out/alignerMlpParamedOneHeadSharedGating/lit-llama-2-lima/7B/1vector-start_layer2-lr9e-05bs32/epoch-10.0-iter-009999.pth"
...
def train(
    ...
    for iter_num in range(start_iter,max_iters):
        ...
        if iter_num % log_interval == 0:
            ...
            fabric.print(f"learnable suffix token:", other[2])
            fabric.print(f"generated embd seed:", other[0])
            fabric.print(f"gating factor of the embd:", other[1])
