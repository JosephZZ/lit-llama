...
promptAligner_version = "V7NoBase"
from lit_llama.promptAlignerV7NoBase import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
...
def train(
    ...
    for iter_num in range(start_iter,max_iters):
        ...
        if iter_num % log_interval == 0:
            ...
            fabric.print(f"generated embd:", other[0])
