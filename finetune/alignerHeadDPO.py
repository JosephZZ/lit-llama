...
warmup_iters = 0.3 * (epoch_size // micro_batch_size) // devices  # 2 alpaca epochs
start_iter = 0
...
previous_aligner_path = "out/alignerOneHeadSharedGating/lit-llama-2-beaver_safe2/7B/1vector-start_layer2-lr0.009bs32-weightDecay0.02-wu0.3/final.pth"
aligner_base_version ="beaver_safe_alpacaStyle_SFT" #"hhSFT" # 
previous_optimizer_path = ""
out_dir = Path(f"out/DPO/alignerHEAD/{model_base}-{data_dir.name}/{model_version}/base_{aligner_base_version}-{aligner_length}vector-start_layer{aligner_start_layer}-lr{learning_rate}bs{int(batch_size)}/")
