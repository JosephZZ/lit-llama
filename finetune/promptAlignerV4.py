...
promptAligner_version = "V4"
if promptAligner_version == "V4":
    from lit_llama.promptAlignerV4 import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
else:
