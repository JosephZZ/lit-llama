...
promptAligner_version = "V3"
if promptAligner_version == "V3":
    from lit_llama.promptAlignerV3 import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
else:
...
data_dir = project_home_dir / "data/philosopherQA_mydata" #philosopherQA_mydata

initial_embedding_base_path = "out/aligner/lit-llama-2-baize/7B/1vector-start_layer2-lr9e-05bs64/epoch-2.55967-iter-255967.pth"
...
def train(
    ...
    for iter_num in range(start_iter,max_iters):
        ...
        if iter_num % log_interval == 0:
            ...
            fabric.print(f"prefix embd base:", other[2])
            fabric.print(f"generated embd residue:", other[0])
            fabric.print(f"gating factor of the embd residue:", other[1])
