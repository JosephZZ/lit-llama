...
from lit_llama.alignerMlpParamedSharedGating import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
...
out_dir = Path(f"out/alignerMlpParamedSharedGating/{model_base}-{data_dir.name}/{model_version}/{aligner_length}vector-start_layer{aligner_start_layer}-lr{learning_rate}bs{int(batch_size)}/")
