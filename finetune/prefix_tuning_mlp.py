...
from lit_llama.prefix_tuning_mlp import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
...
out_dir = Path(f"out/prefix_tuning_mlp/{model_base}-{data_dir.name}/{model_version}/{prefix_length}vector-lr{learning_rate}bs{int(batch_size)}/")
...
def main():
    ...
    with fabric.init_module():
        ...
        if previous_prefix_length:
            model.load_state_dict(torch.load(previous_prefix_length), strict=False)
