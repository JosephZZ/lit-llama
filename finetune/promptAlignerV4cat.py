...
promptAligner_version = "V4cat"
if promptAligner_version == "V4cat":
    from lit_llama.promptAlignerV4cat import LLaMA, LLaMAConfig, mark_only_adapter_as_trainable, adapter_state_from_state_dict
else:
...
initial_embedding_base_path = "out/aligner/lit-llama-2-orca/7B/1vector-start_layer2-lr9e-05bs32/epoch-1.3.pth"
...
eval_interval = 600
save_interval = 1 * epoch_size // (batch_size*devices)  # x epochs
eval_iters = 2000
log_interval = 50
