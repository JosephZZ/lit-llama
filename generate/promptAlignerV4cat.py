...
def main(
    ...
    aligner_path: Path = project_home_dir / "out/aligner/lit-llama-2-orca/7B/1vector-start_layer2-lr9e-05bs32/epoch-1.3.pth",
    ...
    with lazy_load(pretrained_path) as pretrained_checkpoint, lazy_load(aligner_path) as adapter_checkpoint:
        ...
        with fabric.init_module(empty_init=True), quantization(mode=quantize):
            model = LLaMA.from_name(name, aligner_length=aligner_length)
