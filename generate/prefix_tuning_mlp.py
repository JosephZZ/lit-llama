...
from lit_llama.prefix_tuning_mlp import LLaMA
...
def main(
    ...
    input: str = "",
    aligner_path: Path = Path("out/prefix_tuning/lit-llama-2-lima/7B/1vector-lr0.0001bs16/epoch-10.0-iter-009999.pth"),
