...
def main(
    ...
    aligner_path: Path = Path("out/promptAlignerV3/lit-llama-2-philosopherQA_mydata/7b-chat/1vector-start_layer2-lr1e-05bs32/epoch-41.0.pth"),
    ...
    initial_embedding_base_path: Path = Path( "out/aligner/lit-llama-2-philosopherQA_mydata/7b-chat/1vector-start_layer2-lr9e-05bs32/epoch-15.0-iter-239999.pth"),
